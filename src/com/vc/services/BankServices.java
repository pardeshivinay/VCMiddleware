...
public class BankServices {
	...
	/*	String msg = "Your standing instruction has been invoked. Pay Rs. 5000  to virtual address 55 xyz@icici for Loan Payment";
		
		String pattern = "(?<=Pay Rs\\.).*(?=to).*";
*/
		
		/*String msg ="This is an important example about regex for my work and for me.";
		String pattern = "an\\s+(.*?)\\s+for";*/
		...
		String remarksPattern = "for\\s+(.*)"; //address
	      ...
	      if (m.find( )) {
	         ...
	         System.out.println("Amount: " + m.group(1) );
	      ...
	      if (m.find( )) {
	         //System.out.println("Found value: " + m.group(0) );
	         System.out.println("Virtual Address: " + m.group(1) );
	         //System.out.println("Found value: " + m.group(2) );
	      } else {
	         System.out.println("NO MATCH");
	      }
	      ...
	      if (m.find( )) {
	        System.out.println("Found value: " + m.group(0) );
	         System.out.println("Remarks: " + m.group(1) );
	         //System.out.println("Found value: " + m.group(2) );
	      } else {
	         System.out.println("NO MATCH");
	      }
